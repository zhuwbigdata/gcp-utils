...
TK_LIBS='-L/staging/libraries/lib -lX11 -L/staging/libraries/lib -lXft   -lfontconfig  -lpthread -ldl -lz  -lpthread -lm'

# Top-level directory in which Tk's platform-independent files are
# installed.
TK_PREFIX='/staging/libraries'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/staging/libraries'

# -I switch(es) to use to make all of the X11 include files accessible:
TK_XINCLUDES='-I/staging/libraries/include'

# Linker switch(es) to use to link with the X11 library archive.
TK_XLIBSW='-L/staging/libraries/lib -lX11'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/staging/tk8.6.9/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/staging/libraries/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/staging/libraries/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/staging/tk8.6.9/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/staging/libraries/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/staging/tk8.6.9/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/staging/libraries/lib/libtkstub8.6.a'
