...
# installed.
TCL_PREFIX='/staging/libraries'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/staging/libraries'
...
TCL_EXTRA_CFLAGS='-I/staging/libraries/include -I/staging/libraries/lib/libffi-3.2.1/include -pipe -I/staging/libraries/include -I/staging/libraries/lib/libffi-3.2.1/include'
...
TCL_LD_FLAGS='-L/staging/libraries/lib -L/staging/libraries/lib64 -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/staging/tcl8.6.9/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/staging/libraries/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/staging/libraries/include'
...
# compiled.
TCL_SRC_DIR='/staging/tcl8.6.9'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/staging/libraries/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/staging/tcl8.6.9/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/staging/libraries/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/staging/tcl8.6.9/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/staging/libraries/lib/libtclstub8.6.a'
